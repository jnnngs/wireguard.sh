...
const  wget = document.querySelector('#wget');wget.addEventListener('mouseleave',clearTooltip);wget.addEventListener('blur',clearTooltip);
const  curl = document.querySelector('#curl');curl.addEventListener('mouseleave',clearTooltip);curl.addEventListener('blur',clearTooltip);
