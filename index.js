...
function showTooltip(elem,msg){elem.setAttribute('class','btn');elem.setAttribute('data-tooltip',msg);setTimeout( function() {elem.setAttribute('data-tooltip','Click to Copy');}, 1000);}
